...
const columns = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "NBME Calculator", href: "/nbme-calculator" },
      { label: "UWSA Converter", href: "/uwsa-1-to-step-1" },
              ...
              <ul className="space-y-2.5">
                {col.links.map((link) => (
                  <li key={link.href}>
                    <Link
                      href={link.href}
                      className="text-sm text-gray-600 hover:text-mint-700 transition"
                    >
                      {link.label}
                    </Link>
                  </li>
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              className="h-10 w-10 rounded-full border border-gray-200 flex items-center justify-center hover:border-gray-400 hover:bg-white transition"
            >
