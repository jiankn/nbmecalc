...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  // Title and meta description rewrite driven by the 2026-08-10 Search
  ...
  const liveRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE_URL}/uwsa-2-to-step-2`, lastModified: snippetRewriteUpdate, changeFrequency: "weekly", priority: 0.85 },
    { url: `${SITE_URL}/free-120-predictor`, lastModified: snippetRewriteUpdate, changeFrequency: "weekly", priority: 0.85 },
    { url: `${SITE_URL}/amboss-converter`, lastModified: snippetRewriteUpdate, changeFrequency: "weekly", priority: 0.85 },
    ...
    { url: `${SITE_URL}/compare/vs-nbcalc`, lastModified: snippetRewriteUpdate, changeFrequency: "monthly", priority: 0.65 },
